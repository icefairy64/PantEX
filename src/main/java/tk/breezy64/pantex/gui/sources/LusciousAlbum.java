 ...
 */
@Extension
public class LusciousAlbum extends ImageSourceRequester<LusciousSource> {
    ...
    protected LusciousSource performRequest() {
        ...
        chooser.getDialogPane().getStylesheets().add(MainController.class.getResource("/src/main/resources/css/default.css").toString());
        ...
        Optional<String> album = tid.showAndWait();
        return album.isPresent() ? new LusciousSource(res.get().name, album.get()) : null;
    }
